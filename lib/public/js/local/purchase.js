...
$(document).ready(function(){
    ...
    $('#savePurchase').click(function(e){
        entry_field_validation(e);
        amount_field_validator(e);
        
        var input_tax_amount = $("input.tax_amount").val();
        if(input_tax_amount == ""){
            e.preventDefault();
            alert("Tax amount should not be Zero.");
        }
...
function entry_field_validation(e){
...
function amount_field_validator(e){
    var i=1;
    total=0;
    amount=0;
    var input_amount=0;
